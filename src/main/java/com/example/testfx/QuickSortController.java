...
public class QuickSortController {
    ...
    public void onSortButtonClicked(ActionEvent e){
        ...
        if(isTime.isSelected()){
            ...
            QuickSort.quickSort(selectionSortController.getArray(), 0, selectionSortController.getArraySize()-1);
            ...
            logs = QuickSort.quickSortLogs(logs, selectionSortController.getArray(), 0, selectionSortController.getArraySize()-1);
            for(String i: logs){
